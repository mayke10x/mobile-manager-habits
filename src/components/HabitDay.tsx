...
interface Props extends TouchableOpacityProps {
    ...
    amountCompletes?: number;
    date: Date;
}

export function HabitDay({ amountOfHabits = 0, amountCompletes = 0, date, ...rest }: Props) {
    const amountAccomplishedPercentage = amountOfHabits > 0 ? generateProgressPercentage(amountOfHabits, amountCompletes): 0;
